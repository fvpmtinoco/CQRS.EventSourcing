...
public class PostAggregate : AggregateRoot
{
    ...
    public void EditComment(Guid commentId, string comment, string username)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannot edit a comment from an inactive post.");
        }
    ...
    public void RemoveComment(Guid commentId, string username)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannot delete a comment from an inactive post.");
        }
